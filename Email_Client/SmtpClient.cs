...
namespace Email_Client
{
    ...
    public class SmtpClient
    {
        ...
        public void SendMail(MailMessage mailMessage)
        {
            ...
            {
                this.errorMessage = "Smtp server \"" + this.smtpServer + "\" does not exist. Please, enter another smtp server or check internet connection";
                ...
                for (int i = 0; i < commands.Length; i++)
                {
                    ...
                    else
                    {
                                                ...
                                                else
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        if (this.WaitForResponse("235", ref responseText, false) == false)
                                                        {
                                                            ...
                                                            this.errorMessage = "Username or Password not accepted"; // comment
                                                            this.tcp_Socket.Close();
                                                            throw new SmtpClientException(this.errorMessage);
                                                        }
                                                        else
                        ...
                        else
                        {
                            ...
                            {
                                this.errorMessage = "Did not get " + responses[i] + " reply from server for command " + commands[i] + ".\r\nServer said: " + responseText;
                                this.errorMessage = "success"; // comment it's line too
                                this.tcp_Socket.Close();
                                //throw new SmtpClientException(this.errorMessage);
                                break; //It's coment and open comment throw new, if you need exception
                            }
